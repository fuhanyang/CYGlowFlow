...
func (s *UserServiceImpl) DeleteAccount(ctx context.Context, req *user.DeleteAccountReq) (resp *user.DeleteAccountResp, err error) {
	resp, err = service.NewDeleteAccountService(ctx).Run(req)
