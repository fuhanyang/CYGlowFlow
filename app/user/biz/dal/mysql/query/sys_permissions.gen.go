...
func newSysPermission(db *gorm.DB, opts ...gen.DOOption) sysPermission {
	...
	_sysPermission.PermKey = field.NewString(tableName, "perm_key")
	_sysPermission.Type = field.NewInt32(tableName, "type")
	_sysPermission.Path = field.NewString(tableName, "path")
	_sysPermission.Method = field.NewString(tableName, "method")
...
type sysPermission struct {
	...
	PermKey   field.String // 权限标识(如 user:list)
	Type      field.Int32  // 类型 1:菜单 2:按钮/API
	Path      field.String // 前端路由或后端API路径
	Method    field.String // HTTP方法(GET, POST等)
...
func (s *sysPermission) updateTableName(table string) *sysPermission {
	...
	s.PermKey = field.NewString(table, "perm_key")
...
func (s *sysPermission) WithContext(ctx context.Context) ISysPermissionDo {
