...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.AccountNum = field.NewInt64(tableName, "account_num")
...
func (u *user) updateTableName(table string) *user {
	...
	u.AccountNum = field.NewInt64(table, "account_num")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["id"] = u.ID
	u.fieldMap["account_num"] = u.AccountNum
