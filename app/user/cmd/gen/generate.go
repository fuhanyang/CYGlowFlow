...
import (
	...
	"github.com/fuhanyang/CYGlowFlow/app/user/conf"
...
func main() {
	...
	// 3. (可选) 执行 SQL 建表语句
	// 读取 biz/dal/mysql/sql/user.sql
	sqlFile := "biz/dal/mysql/sql/user.sql"
	...
	g := gen.NewGenerator(gen.Config{
		...
		// 假设在 app/user 下运行 go run cmd/gen/generate.go
